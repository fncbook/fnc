...
::::{prf:example} Blurring an image Blurring an image Blurring an image Blurring an image
`````{tab-set} 
````{tab-item} Julia
:sync: julia
...
::::{prf:example} Deblurring an image Deblurring an image Deblurring an image Deblurring an image
`````{tab-set} 
````{tab-item} Julia
:sync: julia
