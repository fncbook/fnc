...
```{code-cell}
disp("Welcome to MATLAB! Do you know π to 15 digits? Because I do! Look:")
format long
pi
```
...
```{tip}
All the content is generated by the code that you see on the pages. If you see it done here, you should be able to make it work for yourself. But first, set up your computing environment as described [here](#section-setup-matlab).
```
