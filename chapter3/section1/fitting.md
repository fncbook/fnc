...
:open:
```{include} julia/tempinterp.ipynb
```
````
`````
...
````{dropdown} Interpolating temperature data
:open:
```{include} matlab/tempinterp.ipynb
```
````
`````
...
````{dropdown} Interpolating temperature data
:open:
```{include} python/tempinterp.ipynb
```
````
`````
``````
