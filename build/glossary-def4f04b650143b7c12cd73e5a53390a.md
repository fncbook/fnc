...
(@section-ivp-basics>`, {numref}`§ {number} <section-ivp-systems)
...
(@section-linsys-polyinterp>`, {numref}`§ {number} <section-localapprox-interpolation)
...
(@section-ivp-euler>`, {numref}`§ {number} <section-ivp-multistep)
...
(@section-localapprox-fd-converge>`, {numref}`§ {number} <section-localapprox-integration>`, {numref}`§ {number} <section-ivp-euler>`, {numref}`§ {number} <section-ivp-multistep)
...
(@section-linsys-condition-number>`, {numref}`§ {number} <section-nonlineqn-rootproblem)
...
(@section-linsys-structure>`, {numref}`§ {number} <section-krylov-structure)
...
(@section-ivp-implicit>`, {numref}`§ {number} <section-diffusion-stiffness)
...
(@section-localapprox-integration>`, {numref}`§ {number} <section-ivp-multistep)
...
(@section-localapprox-fd-converge>`, {numref}`§ {number} <section-localapprox-integration)
...
(@section-localapprox-finitediffs>`, {numref}`§ {number} <section-localapprox-integration>`, {numref}`§ {number} <section-globalapprox-integration)
