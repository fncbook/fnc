...
This is not especially close to the exact values of $f'$, which are $\bigl[ -3.142, -2.221, 0, 2.221, 3.142 \bigr]$, but we should not expect it to be for such a small $n$.
::::
