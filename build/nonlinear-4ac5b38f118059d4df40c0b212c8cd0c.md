...
```{note}
Take a moment to read through @function-elliptic slowly. Nearly every line is related to a topic in this book that took you some time to absorb. This is how most large problems in scientific computing are solved: by decomposing until you reach steps that are recognizable as standard problems.
```
