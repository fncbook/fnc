...
1. 
    ...
    **(b)** ⌨ Repeat the convergence experiment in the second part of {numref}`Demo %s <demo-diffmats-2nd>`, but using this version of $\mathbf{D}_x^2$ rather than $\mathbf{D}_{xx}$ to estimate $f''$. What is the apparent order of accuracy in $f''$?
