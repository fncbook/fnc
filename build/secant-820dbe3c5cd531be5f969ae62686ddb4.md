...
⌨ Write a function `iqi(f, x1, x2, x3)` that performs inverse quadratic interpolation for finding a root of $f$ given three initial estimates. Test your function on $x^2=e^{-x}$, over $[-2,2]$.
``````
