...
````{tab-item} Julia
:sync: julia
Download [a data file](https://raw.github.com/fncbook/fnc/master/julia/smallworld.mat) by clicking the link.
``` julia
using MAT
...
````{tab-item} MATLAB
:sync: matlab
Download [a data file](https://raw.github.com/fncbook/fnc/master/matlab/smallworld.mat) by clicking the link.
``` matlab
load smallworld
```
```` 
...
````{tab-item} Python
:sync: python
Download [a data file](https://raw.github.com/fncbook/fnc/master/python/smallworld.mtx) by clicking the link.
``` python
