...
```{math}
\rule[-1.1cm]{1cm}{2.4cm} = \rule[-1.1cm]{2.4cm}{2.4cm} \cdot \rule[-1.1cm]{1cm}{2.4cm} \cdot \rule[-4mm]{1cm}{1cm},
```

while a thin SVD looks like

```{math}
\rule[-1.1cm]{1cm}{2.4cm} = \rule[-1.1cm]{1cm}{2.4cm} \cdot \rule[-4mm]{1cm}{1cm} \cdot \rule[-4mm]{1cm}{1cm}.
```
```
