...
```{code-cell}
Q, errest = quad(exp, 0, 1, epsabs=1e-15, epsrel=1e-15)
print(Q)
...
```{code-cell}
Q, errest = quad(lambda x: exp(sin(x)), 0, 1, epsabs=1e-15, epsrel=1e-15)
print(Q)
```
...
```{code-cell}
QI, errest = quad(f, a, b, epsabs=1e-14, epsrel=1e-14)
