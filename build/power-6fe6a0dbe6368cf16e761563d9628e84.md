...
This is {term}`linear convergence`.

::::{prf:observation}
Given @evorder2, the error in the power iteration eigenvalue estimates $\beta_k$ is reduced asymptotically by a constant factor $\lambda_2/\lambda_1$ at each iteration.
::::
