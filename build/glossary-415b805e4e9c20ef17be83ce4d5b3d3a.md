...
order of accuracy
: Leading power of the truncation error as a function of a discretization size parameter. (@definition-algebraicconvergebce, @definition-orderfd, @definition-truncationint, @section-ivp-euler, @section-ivp-multistep)
...
truncation error
: Difference between an exact value and an approximation, such as one that truncates an infinite series. (@definition-truncationfd, @definition-truncationint)
