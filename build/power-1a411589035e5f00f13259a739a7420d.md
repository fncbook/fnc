...
& \le \underbrace{\left|\frac{z_2}{z_1}\right|}_{c_2} \cdot \underbrace{ \left| \frac{\lambda_2}{\lambda_1} \right|}_{r_2} ^k  \twonorm{\mathbf{v}_{2}}
+ \cdots + \underbrace{\left|\frac{z_n}{z_1}\right|}_{c_n} \cdot \underbrace{\left|\frac{\lambda_n}{\lambda_1}\right|}_{r_n} ^k  \twonorm{\mathbf{v}_{n}}  \\ 
