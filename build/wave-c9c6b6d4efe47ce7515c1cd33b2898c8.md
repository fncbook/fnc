...
The vibrations of a stiff beam, such as a ruler, are governed by the PDE $u_{tt}=-u_{xxxx}$, where $u(x,t)$ is the deflection of the beam at position $x$ and time $t$. This is called the **beam equation**.
...
also satisfy the beam equation. 
