...
We can solve the TPBVP {eq}`tpbvp` by recasting the problem as a first-order system, as introduced in @section-ivp-systems#transformation-of-high-order-systems 
