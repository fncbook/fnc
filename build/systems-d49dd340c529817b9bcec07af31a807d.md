...
:open:
```{include} julia/coupledpendula.ipynb
```
````
`````
...
````{dropdown} Coupled pendulums
:open:
```{include} matlab/coupledpendula.ipynb
```
````
`````
...
````{dropdown} Coupled pendulums
:open:
```{include} python/coupledpendula.ipynb
```
````
`````
``````
