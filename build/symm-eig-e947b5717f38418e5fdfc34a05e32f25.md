...
As a consequence of @theorem-rayleighquotient, the Rayleigh quotient can be used to turn an eigenvector estimate into an eigenvalue estimate. Specifically, a multidimensional Taylor series implies that
