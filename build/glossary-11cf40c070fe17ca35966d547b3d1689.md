...
order of accuracy
: Leading power of the truncation error as a function of a discretization size parameter. (@definition-algebraicconvergebce, @definition-orderfd, @section-localapprox-integration, @section-ivp-euler, @section-ivp-multistep)
