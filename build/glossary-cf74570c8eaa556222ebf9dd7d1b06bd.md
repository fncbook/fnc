...
weights
: Coefficients, usually all positive, applied in a linear combination of function values in a finite-difference or integration method. (@section-localapprox-finitediffs, @section-localapprox-integration, @definition-barycentricweights)
