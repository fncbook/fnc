...
:open:
The matrix in [this data file](https://raw.github.com/fncbook/fnc/master/julia/voting.jld2) describes the votes on bills in the 111th session of the United States Senate. (The data set was obtained from [https://voteview.com].) Each row is one senator, and each column is a vote item.
