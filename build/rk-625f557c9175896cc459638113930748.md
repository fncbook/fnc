...
✍ Use Heun's method to solve the problems in @problem-rk-byhand with $n=100$. Plot the numerical solution and error over the entire time interval given.
``````
...
✍ Use RK4 to solve the problems in @problem-rk-byhand with $n=100$. Plot the numerical solution and error over the entire time interval given.
``````
