...
```{math}
\rule{1cm}{2.4cm} \raisebox{11mm}{=} \rule{2.4cm}{2.4cm} \raisebox{11mm}{$\centerdot$} \rule{1cm}{2.4cm} \raisebox{11mm}{$\centerdot$} \rule[4mm]{1cm}{1cm}\quad ,
```

while a thin SVD looks like

```{math}
\rule[-1.1cm]{1cm}{2.4cm} = \rule[-1.1cm]{1cm}{2.4cm} \centerdot \rule[-4mm]{1cm}{1cm} \centerdot \rule[-4mm]{1cm}{1cm} \quad.
```
