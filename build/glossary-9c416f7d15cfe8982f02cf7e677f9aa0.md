...
weights
: Coefficients applied within a linear combination of function values in a finite-difference or integration method. (@definition-finitedifference, @section-localapprox-integration, @definition-barycentricweights)
